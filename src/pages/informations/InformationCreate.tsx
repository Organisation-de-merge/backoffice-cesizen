...
import { createPage } from "../../services/informationService";
...
export default function InformationCreate() {
  ...
  return (
    <div>
      <h1 className="text-3xl font-bold mb-6">Créer un article d'information</h1>
      <form onSubmit={handleSubmit} className="max-w-xl space-y-4">
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-3 py-2 rounded bg-gray-100 text-black file:mr-2 cursor-pointer file:cursor-pointer file:py-1 file:px-3 file:border-0 file:rounded file:bg-green-600 file:text-white"
          />
        </div>
